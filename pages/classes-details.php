        ...
        <div class="flex gap-2">
            ...
            <?php if ($kelas): ?>
                <a href="../classes/edit?id=<?= htmlspecialchars($kelas['id']) ?>"
                   class="inline-flex items-center gap-2 bg-primary-50 hover:bg-primary-100 text-primary-700 border border-primary-200 px-4 py-2 rounded-lg font-medium transition-colors">
                    <iconify-icon icon="cil:pencil" width="20"></iconify-icon>
                    Edit Data
                </a>
                <a href="../classes/delete?id=<?= htmlspecialchars($kelas['id']) ?>"
                   class="inline-flex items-center gap-2 bg-status-error-100 hover:bg-status-error-200 text-status-error-700 border border-status-error-200 px-4 py-2 rounded-lg font-medium transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <div class="mb-4">
                        ...
                        <div class="rounded-lg bg-secondary-50 px-3 py-2 text-gray-800 border border-gray-200"><?= htmlspecialchars($kelas['id']) ?></div>
                    </div>
                    <div class="mb-4">
                        <label class="block font-semibold text-primary-700 mb-1">Nama Kelas</label>
                        <div class="rounded-lg bg-secondary-50 px-3 py-2 text-gray-800 border border-gray-200"><?= htmlspecialchars($kelas['nama_kelas']) ?></div>
                    </div>
                    <div class="mb-4">
                        <label class="block font-semibold text-primary-700 mb-1">Tahun Ajaran</label>
                        <div class="rounded-lg bg-secondary-50 px-3 py-2 text-gray-800 border border-gray-200"><?= htmlspecialchars($kelas['nama_tahun_ajaran']) ?></div>
                    </div>
                </div>
                <div>
                    <div class="mb-4">
                        <label class="block font-semibold text-primary-700 mb-1">Tingkat</label>
                        <div class="rounded-lg bg-secondary-50 px-3 py-2 text-gray-800 border border-gray-200"><?= htmlspecialchars($kelas['nama_tingkat']) ?></div>
                    </div>
                    <div class="mb-4">
