...
<div class="bg-white rounded-lg shadow p-6 border border-gray-200">
    ...
    <form method="POST" action="" class="space-y-6">
        ...
        <div class="flex flex-wrap justify-end gap-2 pt-2">
            ...
            <a href="<?= htmlspecialchars($urlPrefix) ?>/absensi/details?id=<?= htmlspecialchars($absensi['id']) ?>" class="inline-flex items-center gap-2 bg-secondary-100 hover:bg-secondary-200 text-secondary-700 border border-secondary-300 px-4 py-2 rounded-lg font-medium transition-colors">
