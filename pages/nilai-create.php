    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <form method="POST" action="" class="space-y-6">
            ...
            <div class="flex flex-row justify-end gap-2 pt-6">
                <button type="submit"
                        class="inline-flex items-center justify-center rounded-lg bg-primary-600 hover:bg-primary-700 text-white font-semibold px-5 py-2 shadow transition">
                ...
                <button type="reset"
                    ...
                    <iconify-icon icon="mdi:arrow-u-left-top" width="20" class="mr-2"></iconify-icon>
                    Reset Form
                </button>
            </div>
        </form>
