    ...
    <form method="POST" action="" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="nis" name="nis" required value="<?= htmlspecialchars($_POST['nis'] ?? '') ?>">
            </div>
            <div>
                <label for="nisn" class="block font-medium text-sm mb-1">NISN <span class="text-status-error-600">*</span></label>
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="nisn" name="nisn" required value="<?= htmlspecialchars($_POST['nisn'] ?? '') ?>">
            </div>
            <div class="md:col-span-2">
                <label for="nama" class="block font-medium text-sm mb-1">Nama <span class="text-status-error-600">*</span></label>
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="nama" name="nama" required value="<?= htmlspecialchars($_POST['nama'] ?? '') ?>">
            </div>
            <div>
                <label for="no_kk" class="block font-medium text-sm mb-1">Nomor Kartu Keluarga</label>
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="no_kk" name="no_kk" value="<?= htmlspecialchars($_POST['no_kk'] ?? '') ?>">
            </div>
            <div>
                <label for="tanggal_lahir" class="block font-medium text-sm mb-1">Tanggal Lahir <span class="text-status-error-600">*</span></label>
                <input type="date" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="tanggal_lahir" name="tanggal_lahir" required value="<?= htmlspecialchars($_POST['tanggal_lahir'] ?? '') ?>">
            </div>
            <div>
            ...
            <div>
                ...
                <textarea class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="alamat" name="alamat" rows="3" required><?= htmlspecialchars($_POST['alamat'] ?? '') ?></textarea>
            </div>
            <div>
                <label for="nama_ayah" class="block font-medium text-sm mb-1">Nama Ayah</label>
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="nama_ayah" name="nama_ayah" value="<?= htmlspecialchars($_POST['nama_ayah'] ?? '') ?>">
            </div>
            <div>
                <label for="nik_ayah" class="block font-medium text-sm mb-1">NIK Ayah</label>
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="nik_ayah" name="nik_ayah" value="<?= htmlspecialchars($_POST['nik_ayah'] ?? '') ?>">
            </div>
            <div>
                <label for="nama_ibu" class="block font-medium text-sm mb-1">Nama Ibu</label>
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="nama_ibu" name="nama_ibu" value="<?= htmlspecialchars($_POST['nama_ibu'] ?? '') ?>">
            </div>
            <div>
                <label for="nik_ibu" class="block font-medium text-sm mb-1">NIK Ibu</label>
                <input type="text" class="w-full rounded-lg border border-secondary-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white text-sm" id="nik_ibu" name="nik_ibu" value="<?= htmlspecialchars($_POST['nik_ibu'] ?? '') ?>">
            </div>
        </div>
        ...
        <div class="flex justify-end gap-2 mt-6">
            <button type="submit" class="inline-flex items-center gap-1 px-4 py-2 rounded-lg bg-primary-600 text-white hover:bg-primary-700 transition">
                <iconify-icon icon="cil:save"></iconify-icon> Simpan Data
            </button>
            <button type="reset" class="inline-flex items-center gap-1 px-4 py-2 rounded-lg border border-secondary-300 text-secondary-700 bg-white hover:bg-secondary-100 transition">
                <iconify-icon icon="cil:refresh"></iconify-icon> Reset Form
            </button>
        </div>
    </form>
</div>
