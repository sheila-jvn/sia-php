...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Edit Data Guru</h1>
    ...
    <form method="POST" action="">
        ...
        <div class="row g-3">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="nip" name="nip" required value="<?= htmlspecialchars($teacher['nip'] ?? '') ?>">
            </div>
            <div class="col-md-12">
                <label for="nama" class="form-label">Nama <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama" name="nama" required value="<?= htmlspecialchars($teacher['nama'] ?? '') ?>">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="no_telpon" name="no_telpon" value="<?= htmlspecialchars($teacher['no_telpon'] ?? '') ?>">
            </div>
        </div>
