<?php
$pageTitle = 'Laporan UTS Per Kelas';
...
if (!$errorMessage) {
    ...
    if (!$jenisId) {
        $errorMessage = 'Jenis nilai UTS tidak ditemukan.';
    }
}
...
<div class="max-w-6xl mx-auto p-6">
    <div class="print-container bg-white border border-secondary-300 rounded-lg shadow-lg p-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold text-secondary-900">Laporan Ulangan Tengah Semester (UTS) - Per Kelas</h1>
                        ...
                        <?php if (empty($nilaiList)): ?>
                            <tr>
                                <td colspan="7" class="px-4 py-6 text-center text-secondary-500 align-middle">
                                    Tidak ada data nilai UTS untuk filter ini.
                                </td>
                            </tr>
                        <?php else: ?>
